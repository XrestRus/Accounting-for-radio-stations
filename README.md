# Система учета радиостанций для депо

Приложение предназначено для автоматизации процесса учета, выдачи и возврата радиостанций в железнодорожном депо.
Система позволяет вести полный цикл учета устройств, контролировать их местонахождение, отслеживать техническое
состояние и генерировать отчеты.

## Основные возможности:

- Учет устройств с информацией о статусе и местонахождении
- Выдача устройств сотрудникам и контроль возврата
- Мониторинг просроченных возвратов
- Ведение базы данных сотрудников
- Формирование отчетов и аналитика
- Разграничение доступа (администраторы и операторы)
...
- день 3 (1.5ч): приведение html-кода к чистовому варианту, с едиными стилями, ссылками и открывающимися модалками с
  репозиторием в github, с помощью cursor и модели sonnet 3.7 и 3.5
...
- день 8 (1.2ч): список сотрудников и Журнал операций, форма входа, добавление и редактирование сотрудников, размещение на
  продакшене
- день 9 (1.2ч): экран отчетов, экран управления пользователями, главный экран (Dashboard)
- день 10 (1.4ч): экран инструкции и справки, тестирование и документация, доработки (1,2,3)
...
В проекте реализованы unit-тесты для проверки корректности работы ключевых классов. Для запуска тестов следуйте
инструкции:
