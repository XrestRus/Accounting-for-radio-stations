...
- [x] В роле оператор, разрешены только операции выдачи и возврата устройств и Журнал операций и Управление устройствами
- [x] При добавление и редактирование устройства добавить прикрепление картинки

## Доработки 2
- [x] на странице Выдача устройств, выбор устройств по enter работает корректно, а на странице Возврат устройства есть ошибка
```
Uncaught ReferenceError: searchDeviceByQrCode is not defined
    at HTMLInputElement.onkeydown (return:286:275)
```
- [x] на странице Управление устройствами не открывается меню пользователя, при наведении